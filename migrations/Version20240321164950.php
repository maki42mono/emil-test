 ...
 */
final class Version20240321164950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discount (id INT NOT NULL, code VARCHAR(10) NOT NULL, type SMALLINT NOT NULL, value SMALLINT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('ALTER TABLE discount ALTER COLUMN id SET DEFAULT nextval(\'discount_id_seq\')');
    }
